...
func SetRoutes(r *mux.Router) {
	...
	// DELEEEEEEEEEEEEEEEEEEEEEEETTTTTTTTTTTTTTTE MEEEEEEEEEEE
	r.HandleFunc("/series/ade", controllers.GetTrendAirseatData("trend")).Methods("GET").Queries(
		"f", "{frequency:[AaQqMm]}",
		"i", "{i_list:[A-Za-z0-9,]+}",
		"m", "{m_list:[A-Za-z0-9,]+}",
		"d", "{d_list:[A-Za-z0-9,]+}",
	...
	r.HandleFunc("/series/trend", controllers.GetTrendAirseatData("trend")).Methods("GET").Queries(
		"f", "{frequency:[AaQqMm]}",
		"i", "{i_list:[A-Za-z0-9,]+}",
		"m", "{m_list:[A-Za-z0-9,]+}",
		"d", "{d_list:[A-Za-z0-9,]+}",
	...
	r.HandleFunc("/series/airseat", controllers.GetTrendAirseatData("airseat")).Methods("GET").Queries(
		"f", "{frequency:[AaQqMm]}",
		"i", "{i_list:[A-Za-z0-9,]+}",
		"m", "{m_list:[A-Za-z0-9,]+}",
		"d", "{d_list:[A-Za-z0-9,]+}",
